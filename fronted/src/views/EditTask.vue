...
<template>
  ...
  <dialog ref="myModal" class="w-full h-full">
    <div class="modal-container bg-white w-full h-full top-0 left-0 flex items-center justify-center">
      <div class="modal-content py-4 text-left px-6 flex-grow">
        ...
        <label for="description" class="form-control flex-grow ml-4 mb-8">
          <div class="label">
            <span class="block text-lg font-bold leading-6 text-gray-900 mb-1" style="color: #9391e4">Description</span>
          </div>
      ...
      todo.assignees === null,
        ...
        <div class="modal-action" style="display: flex; justify-content: space-around">
          ...
          <form method="dialog" style="flex: 1">
            <button @click="UpdateTask" type="submit" class="btn" style="background-color: #f785b1; margin: 10px; width: 100%"
