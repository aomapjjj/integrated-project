...
<template>
  <div class="w-full h-screen bg-White">
    ...
    <div
      ...
      role="alert" tabindex="-1" aria-labelledby="hs-toast-solid-color-red-label">
      <div id="hs-toast-solid-color-red-label" class="flex p-4" v-show="alertLogin">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
      <div class="flex-1 flex items-center justify-center p-4 lg:p-16 bg-gradient-to-r from-violet-400 to-purple-300">
        <div class="text-focus-in text-center lg:text-left max-w-md">
          ...
          <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-white text-shadowCustom border-black">
            Hi, Welcome to <br />
            Kradan Kanban
          </h1>
      ...
      <div class="flex-1 flex items-center justify-center p-4 lg:p-16 bg-gradient-to-tr from-slate-50 to-gray-50">
        ...
        <div class="flex-1 flex items-center justify-center">
          <div id="formLogin" class="w-full max-w-md rounded-lg shadow-lg p-20 bg-white scale-up-center">
            ...
            <form @submit.prevent="submitForm" class="mt-4">
              ...
              <div class="relative flex items-center mb-6">
                ...
                <div class="flex flex-col mt-6">
                  <input v-model="passwordInput" id="password" :type="isPasswordVisible ? 'text' : 'password'"
                  ...
                  <!-- eyes open -->
                  <svg v-if="isPasswordVisible" @click="isPasswordVisible = !isPasswordVisible"
                    ...
                    <path fill="#d9d9d9" fill-opacity=".15"
                  ...
                  <!-- eyes close -->
                  <svg v-else @click="isPasswordVisible = !isPasswordVisible" xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="flex flex-col mt-4 items-center">
                ...
                <div class="items-center justify-center">
                  <button class="flex w-72 py-2 justify-center rounded-md border border-gray-400">
                    <svg aria-hidden="true" viewBox="0 0 21 21" width="24" height="24">
