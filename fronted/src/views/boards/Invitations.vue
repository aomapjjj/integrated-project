        ...
        <div class="flex flex-col justify-center items-center h-[100vh]">
          ...
          >
            ...
            <div class="mt-16 flex flex-col items-center">
              ...
              >
                <p>
                  <span class="font-semibold">{{ boardOwnerName }}</span> has
                  invited you to collaborate with
                  <span class="font-semibold">{{ item.accessRight }}</span>
                  access right on
          ...
          <div v-if="filteredCollaboratorInfo.length === 0">
            <p>Sorry, we couldn't find your active invitation to this board</p>
          </div>
        </div>
      </div>
    </div>
