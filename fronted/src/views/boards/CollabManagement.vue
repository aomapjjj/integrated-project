    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="flex flex-col flex-1">
        ...
        <div class="flex flex-col items-center mt-2">
          <div>
            <div class="bg-base-100 mt-4 md:mt-0 flex justify-center items-center"
            ...
            <div v-else :class="[
              ...
              <CollaboratorCard v-for="(item, index) in collaboratorInfo" :key="item.id">
                <template #status>
                  <!-- pendind -->
                  <div class="flex items-center">
                    <svg v-if="item.status === 'PENDING'" xmlns="http://www.w3.org/2000/svg"
                      class="w-3 h-3 text-yellow-400" viewBox="0 0 24 24">
                      <path fill="currentColor"
                    ...
                    <!-- accept -->
                    <svg v-if="item.status === 'ACCEPTED'" xmlns="http://www.w3.org/2000/svg"
                      class="w-3 h-3 text-green-400" viewBox="0 0 24 24">
                      <path fill="currentColor" fill-rule="evenodd"
                ...
                <template #access-right>
                  <div class="itbkk-access-right">
                    <div class="relative inline-block text-left">
                      <button @click="openDropdownAccess(item.id)" type="button"
                ...
                <template #btn>
                  <button :disabled="disabledButtonWhileOpenPublic" @click="showRemoveModal(item)"
                    ...
                    :class="item.status === 'PENDING'
                      ...
                      ">
                    <!-- cancel -->
                    <svg v-if="item.status === 'PENDING'" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                    ...
                    <!-- delete -->
                    <svg v-else-if="item.status === 'ACCEPTED'" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                      viewBox="0 0 24 24">
                      <path fill="currentColor"
            ...
            <ConfirmModal :openModal="showConfirmModal" @confirm="confirmRemove()" @cancel="showConfirmModal = false">
              ...
              <template #confirmBtn>
                <span :class="collaboratorToRemove?.status === 'PENDING'
