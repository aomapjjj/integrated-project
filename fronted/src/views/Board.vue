  ...
  <div class="min-h-full max-h-fit">
    <div class="min-h-screen flex">
      ...
      <div class="flex-1 flex flex-col">
        <!-- Navbar -->
        <nav class="bg-white shadow py-4 flex justify-between items-center w-full" style="background-color: #d8f1f1">
          <div class="ml-10">
          ...
          <div class="text-3xl font-bold tracking-tight" style="color: #9391e4; text-shadow: 0 0 5px #ffffff">
            Board List
          </div>
          <div class="flex items-center space-x-2 mr-3">
            ...
            <span class="itbkk-fullname flex font-bold" style="color: #9391e4; text-shadow: 0 0 5px #ffffff">{{ userName
              }}</span>
          </div>
        </nav>
        <!-- <div>
              ...
              <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                      <th scope="col"
                        ...
                        <button class="flex items-center justify-center gap-x-3 focus:outline-none">
                          <span>No.</span>
                        </button>
                      </th>
                      <th scope="col"
                  ...
                  <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                    <tr class="itbkk-item" v-for="(item, index) in BoardsList" :key="index">
                      ...
                      <td class="px-12 py-4 text-sm font-medium text-center whitespace-nowrap">
                        <div
