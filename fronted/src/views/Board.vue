        ...
        <div class="bg-gray-200 w-auto h-auto">
          ...
          <div class="form-control w-52">
            <label class="label cursor-pointer">
              <input type="checkbox" class="itbkk-board-visibility toggle toggle-accent" checked="checked" />
          ...
          <div class="w-full">
            ...
            >
              ...
              <div class="flex justify-center">
                <form method="dialog">
                  <button type="submit" class="itbkk-button-ok btn flex-3 mr-5 bg-customPink" @click="submitForm()"
