...
<template>
  ...
  <div class="flex mt-9 mx-auto ml-[100px]">
    ...
    <dialog id="my_modal_limit" class="modal modal-bottom sm:modal-middle">
      <div class="modal-box" style="max-width: 400px">
        ...
        <div class="modal-action">
          <form method="dialog">
            <button class="btn mr-2 bg-green-400 text-w" @click="UpdateLimit">Confirm</button>
    ...
    <div class="selected-filters flex flex-wrap mt-2">
      <div v-for="status in searchQuery" :key="status"
    ...
    <div class="flex-grow flex justify-end items-center mr-[100px]">
      <div class="hidden md:block">
        <div class="flex space-x-1.5">
          ...
          <AddTask />
          <!-- MANAGE STATUS -->
          <button class="itbkk-manage-status btn bg-gray-200"
            style="color: white; background-color: #f785b1; border-radius: 30px" @click="openNewStatus()">
