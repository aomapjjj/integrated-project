        ...
        <div form @submit.prevent="submitForm" class="flex justify-between w-full h-full"
          ...
          <div class="modal-content py-4 text-left px-6 flex-grow">
            ...
            <label for="description" class="form-control flex-grow ml-4 mb-8">
              <div class="label">
                <span class="block text-lg font-bold leading-6 text-gray-900 mb-1" style="color: #9391e4">Description <p
                    class="text-sm text-red-400 mb-2 mt-2 ">
          ...
          <div class="modal-content py-4 text-left px-10 flex-grow w-1/3 max-w-sm" style="margin-top: 65px">
            <!-- Assignees -->
            <div class="mt-10">
              <span class="block text-lg font-bold leading-6 text-gray-900 mb-2" style="color: #9391e4">Assignees<p
                  class="text-sm text-red-400 mb-2 mt-2">
            ...
            <div class="modal-action">
              <form method="dialog" style="display: flex; justify-content: flex-end">
                <button type="submit"
                  ...
                  style="background-color: #f785b1" :class="{ disabled: todo.title?.length === 0 || !todo.title }"
