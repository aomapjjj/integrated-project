		...
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
				...
				<h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
					<span>S</span><span>O</span><span>R</span><span>R</span><span>Y</span></h1>
					<span class="absolute  top-0   -ml-12  text-gray-300 font-semibold">Oops!</span>
					</div>
				<h5 class="text-gray-300 font-semibold -mr-10 -mt-3">Please log in first, then we will link your email</h5>
				<p class="text-gray-100 mt-2 mb-6">we are sorry, but Log in first to link your email</p>
				<span @click="toLogin"
