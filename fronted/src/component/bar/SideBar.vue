...
<template>
  ...
  <div id="sidebar" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <li class="hs-accordion" id="projects-accordion">
          <button @click="toggleDropdown" :aria-expanded="isExpanded"
            ...
            <div class="badge badge-sm text-xxs">
              {{ BoardsList?.length ? BoardsList?.length : '0' }}
            </div>
            <!-- Icon when expanded -->
            <svg v-if="isExpanded"
          ...
          <!-- Submenu -->
          <div v-show="isExpanded && BoardsList.length"
    ...
    <div class="mt-auto p-2 fixed bottom-0 left-0 w-full lg:relative lg:mt-auto">
      <div class="flex items-center justify-between border border-gray-100 p-2 rounded-full shadow-sm max-w-xs mx-auto">
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <p class="itbkk-fullname text-xs font-medium text-gray-800 dark:text-white">
        ...
        <div class="mt-3">
          <button class="itbkk-sign-out group" @click="clearToken()">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 512 512">
              <path fill="none" stroke="#eb4343" class="group-hover:stroke-red-600" stroke-linecap="round"
