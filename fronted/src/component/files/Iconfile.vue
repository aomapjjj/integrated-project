...
const fileIcon = computed(() => {
  const icons = {
    // Document Files
    pdf: '/image/files/Document/text_color_pdf.png',
    doc: '/image/files/Document/text_color_doc.png',
    docx: '/image/files/Document/text_color_doc.png',
    xls: '/image/files/Document/text_color_xls.png',
    xlsx: '/image/files/Document/text_color_xls.png',
    txt: '/image/files/Document/text_color_txt.png',
    csv: '/image/files/Document/text_color_csv.png',
    ppt: '/image/files/Document/text_color_ppt.png',
...
<template>
  <div>
    ...
    <div v-else class="flex items-center justify-center w-full h-full">
      <img :src="fileIcon" alt="File Icon" class="w-12 h-12" />
    </div>
  </div>
</template>
